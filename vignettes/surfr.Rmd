...
23/07/2019. Note that the block-like structure downstream of site KEN represents
the Kent street weir in an open position. The function will interpret the status 
of the weir from the sonde data and plot it accordingly.
...
the weir is used as a barrier to the calculations.
